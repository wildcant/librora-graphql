...
import { Button, CheckboxField, Logo, TextField, useToast } from 'ui'
import z from 'zod'
...
type RegistrationFormData = z.infer<typeof RegistrationForm>
...
function Register() {
  ...
  const submitRegistration = ({ email, firstName, lastName, password, username }: RegistrationFormData) => {
