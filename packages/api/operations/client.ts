...
export const BookDetailsFragmentFragmentDoc = gql`
...
export const BookBySlugDocument = gql`
  query BookBySlug($slug: String!) {
    book(slug: $slug) {
      ...BookDetailsFragment
    }
  }
  ${BookDetailsFragmentFragmentDoc}
`

/**
 * __useBookBySlugQuery__
 *
 * To run a query within a React component, call `useBookBySlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useBookBySlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBookBySlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
...
export function useBookBySlugQuery(
  baseOptions: Apollo.QueryHookOptions<Types.BookBySlugQuery, Types.BookBySlugQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useQuery<Types.BookBySlugQuery, Types.BookBySlugQueryVariables>(BookBySlugDocument, options)
}
export function useBookBySlugLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<Types.BookBySlugQuery, Types.BookBySlugQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useLazyQuery<Types.BookBySlugQuery, Types.BookBySlugQueryVariables>(
    BookBySlugDocument,
    options
  )
}
export type BookBySlugQueryHookResult = ReturnType<typeof useBookBySlugQuery>
export type BookBySlugLazyQueryHookResult = ReturnType<typeof useBookBySlugLazyQuery>
export type BookBySlugQueryResult = Apollo.QueryResult<Types.BookBySlugQuery, Types.BookBySlugQueryVariables>
...
export function useTopicsQuery(
  baseOptions?: Apollo.QueryHookOptions<Types.TopicsQuery, Types.TopicsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
...
export function useTopicsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<Types.TopicsQuery, Types.TopicsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions }
